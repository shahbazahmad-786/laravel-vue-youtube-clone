...
const addVideo = () => {
    ...
    dispatch("createVideos", data.value).then(() => push({ name: 'Home' }));
}

const getVideo = (e) => data.value.video = e.target.files[0];
const getImage = (e) => data.value.thumbnail = e.target.files[0];
</script>
